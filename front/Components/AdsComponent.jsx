    ...
    <section className="py-24 bg-background relative overflow-hidden border-t border-foreground/5 border-b" dir="rtl">
      ...
      <div className="container mx-auto px-4 md:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          >
            <Link href="/Pages/Store" className="group relative block w-full h-[500px] md:h-[600px] rounded-[3rem] overflow-hidden bg-[#0A0A0A] border border-foreground/5 hover:border-primary/50 transition-all duration-700 shadow-2xl hover:shadow-[0_20px_60px_-15px_rgba(227,27,35,0.4)]">
              
              {/* Image Layer */}
              <div className="absolute inset-0 w-full h-full">
                <Image 
                  src="/ads/ad_store.jpg" 
                  alt="Zamalek Store Ad" 
                  fill 
              ...
              <div className="absolute inset-0 p-10 flex flex-col justify-between z-10">
                {/* Top Badge */}
                <div className="self-end px-5 py-2 rounded-full bg-black/60 backdrop-blur-xl border border-foreground/20 text-foreground font-black text-xs uppercase tracking-widest flex items-center gap-2 group-hover:bg-primary group-hover:border-primary transition-all duration-500">
                  <ShoppingBag size={14} />
                  ZSC STORE
                </div>
                ...
                <div className="space-y-4 translate-y-4 group-hover:translate-y-0 transition-transform duration-500">
                  <h3 className="text-5xl md:text-6xl font-black font-heading text-foreground italic tracking-tighter leading-[0.9] drop-shadow-[0_5px_15px_rgba(0,0,0,0.8)]">
                    قميص <span className="text-transparent bg-clip-text bg-gradient-to-l from-foreground to-red-500">البطـل</span>
                  </h3>
                  <p className="text-foreground/70 font-bold max-w-sm border-r-2 border-primary pr-4">
                    اكتشف التشكيلة الجديدة من أطقم المباريات وملابس التمرين الرسمية لنادي الزمالك.
                  </p>
                  
                  <div className="inline-flex items-center gap-3 pt-4 text-primary group-hover:text-foreground transition-colors font-black text-lg">
                    تسوق الآن 
          ...
          >
            <Link href="/Pages/Membership" className="group relative block w-full h-[500px] md:h-[600px] rounded-[3rem] overflow-hidden bg-[#0A0A0A] border border-foreground/5 hover:border-yellow-500/50 transition-all duration-700 shadow-2xl hover:shadow-[0_20px_60px_-15px_rgba(234,179,8,0.3)]">
              
              {/* Image Layer */}
              <div className="absolute inset-0 w-full h-full">
                <Image 
                  src="/ads/ad_stadium.jpg" 
                  alt="Zamalek VIP Membership Ad" 
                  fill 
              ...
              <div className="absolute inset-0 p-10 flex flex-col justify-between z-10">
                {/* Top Badge */}
                <div className="self-end px-5 py-2 rounded-full bg-black/60 backdrop-blur-xl border border-foreground/20 text-foreground font-black text-xs uppercase tracking-widest flex items-center gap-2 group-hover:bg-yellow-600 group-hover:border-yellow-500 transition-all duration-500">
                  <Crown size={14} />
                  MEMBERSHIP
                </div>
                ...
                <div className="space-y-4 translate-y-4 group-hover:translate-y-0 transition-transform duration-500">
                  ...
                  <p className="text-foreground/70 font-bold max-w-sm border-r-2 border-yellow-500 pr-4">
