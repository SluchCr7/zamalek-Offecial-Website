...
const AdsComponent = () => {
  return (
    <section className="py-24 bg-[#050505] relative overflow-hidden border-t border-white/5 border-b" dir="rtl">
      ...
      <div className="container mx-auto px-4 md:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          >
            <Link href="/Pages/Store" className="group relative block w-full h-[500px] md:h-[600px] rounded-[3rem] overflow-hidden bg-[#0A0A0A] border border-white/5 hover:border-primary/50 transition-all duration-700 shadow-2xl hover:shadow-[0_20px_60px_-15px_rgba(227,27,35,0.4)]">
              ...
              <div className="absolute inset-0 p-10 flex flex-col justify-between z-10">
                {/* Top Badge */}
                <div className="self-end px-5 py-2 rounded-full bg-black/60 backdrop-blur-xl border border-white/20 text-white font-black text-xs uppercase tracking-widest flex items-center gap-2 group-hover:bg-primary group-hover:border-primary transition-all duration-500">
                  <ShoppingBag size={14} />
                  ZSC STORE
                </div>
          ...
          >
            <Link href="/Pages/Membership" className="group relative block w-full h-[500px] md:h-[600px] rounded-[3rem] overflow-hidden bg-[#0A0A0A] border border-white/5 hover:border-yellow-500/50 transition-all duration-700 shadow-2xl hover:shadow-[0_20px_60px_-15px_rgba(234,179,8,0.3)]">
              ...
              <div className="absolute inset-0 w-full h-full">
                ...
                />
                {/* Complex Overlays */}
                <div className="absolute inset-0 bg-gradient-to-t from-black via-black/40 to-transparent group-hover:via-[#020202]/30 transition-all duration-700" />
              ...
              <div className="absolute inset-0 p-10 flex flex-col justify-between z-10">
                {/* Top Badge */}
                <div className="self-end px-5 py-2 rounded-full bg-black/60 backdrop-blur-xl border border-white/20 text-white font-black text-xs uppercase tracking-widest flex items-center gap-2 group-hover:bg-yellow-600 group-hover:border-yellow-500 transition-all duration-500">
                  <Crown size={14} />
                  MEMBERSHIP
                </div>
